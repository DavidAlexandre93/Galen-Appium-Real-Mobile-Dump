...
public class Appium {
	...
	public static void CRhomePageLayoutTest() throws Exception {
		...
		//Realizando o dump dos objects do gspec
		new GalenPageDump("some page").dumpPage(driver, "/specs/homePage.gspec", "dump/home-page");
	...
	public static void CRMyNotesLayoutTest() throws Exception, InterruptedException {
		...
		//Realizando o dump dos objects do gspec
		new GalenPageDump("some page").dumpPage(driver, "specs/mynotes.gspec", "dump/home-page");
	...
	public static void CREventTest() throws Exception, InterruptedException {
		...
		//Realizando o dump dos objects do gspec
		new GalenPageDump("some page").dumpPage(driver, "specs/eventTeste.gspec", "dump/home-page");
